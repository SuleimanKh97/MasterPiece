...
- Create Angular project with ng: `ng new projecttesting.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`projecttesting.client.esproj`).
